...
app.get('/hello', (req, res) => {
  ...
  //       })
  //       .then((response) => {
  //         const cid = response.data.IpfsHash; // Get the CID from the
  //         response return res.json({ cid }); // Send the CID as a response
  //       })
  //       .catch((error) => {
                              ...
                              jsonData,
                              {
                                headers: {
                                  Authorization: `Bearer ${
                                      process.env.PINATA_JWT}`,  // Use JWT for
                                  // authorization
                                },
                              })
                          .then((response) => {
